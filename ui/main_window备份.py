...
from ui.switch_toggle import SwitchToggle  # ✅新增
...
class MainWindow(QWidget):
    def __init__(self, resource_path_func, expire_time: str | None = None, license_key: str = ""):
        ...
        # ⭐ 关键：把文件夹顺序管理器注册到全局状态，供音频轮播线程使用
        try:
            fm = self.folder_panel.manager  # FolderOrderPanel 内部持有的 FolderOrderManager
